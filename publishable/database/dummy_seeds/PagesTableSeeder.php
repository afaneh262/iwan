...
use Afaneh262\Iwan\Models\Page;
...
class PagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!$dataType->exists) {
            $dataType->fill([
                'name'                  => 'pages',
                'display_name_singular' => __('iwan::seeders.data_types.page.singular'),
                'display_name_plural'   => __('iwan::seeders.data_types.page.plural'),
                'icon'                  => 'iwan-file-text',
                'model_name'            => 'Afaneh262\\Iwan\\Models\\Page',
                'controller'            => '',
        ...
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => __('iwan::seeders.data_rows.page_image'),
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $menuItem = MenuItem::firstOrNew([
            'menu_id' => $menu->id,
            'title'   => __('iwan::seeders.menu_items.pages'),
            'url'     => '',
            'route'   => 'iwan.pages.index',
        ]);
        if (!$menuItem->exists) {
            $menuItem->fill([
                'target'     => '_self',
                'icon_class' => 'iwan-file-text',
                'color'      => null,
                'parent_id'  => null,
                'order'      => 7,
            ])->save();
