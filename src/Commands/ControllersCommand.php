...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'iwan:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Iwan.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/afaneh262/iwan/src/Http/Controllers'));
        $namespace = config('iwan.controllers.namespace', 'Afaneh262\\Iwan\\Http\\Controllers');
        ...
        $this->info('Published Iwan controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/afaneh262/iwan/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'Afaneh262\\Iwan\\Http\\Controllers\\'.$class,
            $content
        );
