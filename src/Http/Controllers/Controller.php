...
use Afaneh262\Iwan\Events\FileDeleted;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\Checkbox;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\Coordinates;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\File;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\Image as ContentImage;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\MultipleImage;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\Password;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\Relationship;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\SelectMultiple;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\Text;
use Afaneh262\Iwan\Http\Controllers\ContentTypes\Timestamp;
use Afaneh262\Iwan\Traits\AlertsMessages;
use Validator;
...
abstract class Controller extends BaseController
{
    ...
    {
        if (Storage::disk(config('iwan.storage.disk'))->exists($path)) {
            Storage::disk(config('iwan.storage.disk'))->delete($path);
