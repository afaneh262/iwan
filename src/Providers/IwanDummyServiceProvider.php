...
class IwanDummyServiceProvider extends ServiceProvider
{
    /**
    ...
    private function registerPublishableResources()
    {
        ...
        $publishable = [
            ...
            'dummy_config' => [
                "{$publishablePath}/config/iwan_dummy.php" => config_path('iwan.php'),
            ],
            'dummy_migrations' => [
    ...
    public function registerConfigs()
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/../publishable/config/iwan_dummy.php', 'iwan'
        );
    }
}
