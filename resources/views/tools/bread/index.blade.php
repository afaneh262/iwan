...
@section('page_title', __('iwan::generic.viewing').' '.__('iwan::generic.bread'))

@section('page_header')
    <h1 class="page-title">
        <i class="iwan-bread"></i> BREAD
    </h1>
@stop
                ...
                <table class="table table-striped database-tables">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:right">{{ __('iwan::bread.bread_crud_actions') }}</th>
                        </tr>
                    </thead>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="iwan-trash"></i>  {!! __('iwan::bread.delete_bread_quest', ['table' => '<span id="delete_builder_name"></span>']) !!}</h4>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('iwan.bread.delete', ['id' => null]) }}" id="delete_builder_form" method="POST">
                        {{ method_field('DELETE') }}
