<style type="text/css">
        .iwan .compass .nav-tabs{
            background:none;
            border-bottom:0px;
        }

        .iwan .compass .nav-tabs > li{
            margin-bottom:-1px !important;
        }

        .iwan .compass .nav-tabs a{
            text-align: center;
            font-size: 10px;
            font-weight: normal;
            background: #f8f8f8;
        ...
        #gradient_bg{
            ...
            top: 61px;
            left: 0px;
            background-image: url(/vendor/afaneh262/iwan/assets/images/bg.jpg);
        ...
        .iwan .compass .nav-tabs > li > a:hover{
        ...
        .iwan-link span.resource_label:hover{
            opacity:1;
        }
        ...
        .iwan-link span.resource_label:hover i{
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b3111111', endColorstr='#b3111117',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
        ...
        .iwan #logs .table>thead>tr>th:first-child{
            border-top-left-radius: 3px;
        }

        .iwan #logs .table>thead>tr>th:last-child{
            border-top-right-radius: 3px;
        }
