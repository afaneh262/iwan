@section('database-table-helper-buttons-template')
    <div>
        <div class="btn btn-success" @click="addNewColumn">+ {{ __('iwan::database.add_new_column') }}</div>
        <div class="btn btn-success" @click="addTimestamps">+ {{ __('iwan::database.add_timestamps') }}</div>
        <div class="btn btn-success" @click="addSoftDeletes">+ {{ __('iwan::database.add_softdeletes') }}</div>
    </div>
@endsection
