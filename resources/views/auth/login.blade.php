...
<head>
    ...
    <style>
        ...
        @media (max-width: 767px) {
            ...
            border-left:5px solid {{ config('iwan.primary_color','#22A7F0') }};
        }
        }
    ...
    <div class="row">
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        @if($admin_logo_img == '')
                        <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="{{ iwan_asset('images/logo-icon-light.png') }}" alt="Logo Icon">
                        @else
                        <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="{{ Iwan::image($admin_logo_img) }}" alt="Logo Icon">
                        @endif
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container">
                ...
                <p>{{ __('iwan::login.signin_below') }}</p>

                <form action="{{ route('iwan.login') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-group-default"
                         id="passwordGroup">
                        <label>{{ __('iwan::generic.password') }}</label>
                        <div class="controls">
                            <input type="password"
                                   name="password"
                                   placeholder="{{ __('iwan::generic.password') }}"
                    ...
                    <button type="submit"
                        ...
                        <span class="signingin hidden">
                            ...
                            {{ __('iwan::login.loggingin') }}...
                        </span>
                        <span class="signin">
                            {{ __('iwan::generic.login') }}
                        </span>
                    </button>
