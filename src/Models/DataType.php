...
class DataType extends Model
{
    ...
    {
        return $this->hasMany(Iwan::modelClass('DataRow'))->orderBy('order');
    }
    ...
    {
        return $this->hasMany(Iwan::modelClass('DataRow'))->orderBy('order', 'DESC')->first();
    }
        ...
        try {
            ...
            if ($this->fill($requestData)->save()) {
                ...
                foreach ($fields as $field) {
                    ...
                    if (!$dataRow->save()) {
                        throw new \Exception(__('iwan::database.field_safe_failed', ['field' => $field]));
                    }
                }
                ...
                if ($this->generate_permissions) {
                    Iwan::model('Permission')->generateFor($this->name);
                }
